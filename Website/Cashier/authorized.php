...
<?php
    ...
    if( isset($_GET['qrNameAdmin']) and isset($_GET['qrPassAdmin']) ) {
        ...
        if($rowSearchedAdminName == '') {
            ...
            header("location: cashierPOS.php?transactNum=$transactNum&notify&cashierName=$cashierName&beginBalance=$beginBalance&notify=$notify");
        }
    }
?>
...
<div class="login-page">
    <div class="form">
        ...
        <form class="login-form">
            ...
            <button>Void</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href = "cashierPOS.php?transactNum=<?php echo $transactNum; ?>&cashierName=<?php echo $cashierName; ?>&beginBalance=<?php echo $beginBalance; ?>&notify" style = "text-decoration: none; color: White;"><button class="button" type = "button">Cancel</button></a>
        </form>
    </div>
</div>
</head>
