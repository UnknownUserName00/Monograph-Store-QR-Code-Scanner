<?php
	...
	$staffActivity = "Cashier Resets the Values Displayed on Cashier POS!";
	...
	header("location: ../cashierPOS.php?transactNum=$transactNum&cashierName=$cashierName&beginBalance=$beginBalance&notify=$notify&productItems");
?>